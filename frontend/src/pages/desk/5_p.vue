...
<template>
  <div class="flex h-screen w-screen items-end bg-gray-800 pb-5 ">
    ...
    <div class="relative flex h-1/3 w-full items-center justify-center">
      <Card v-for="(card, index) in gameState.players[0].cards" :key="card.img" :card="card" class="absolute origin-bottom" :class="[calculateRotationClass(0, index), calculateTranslationClass(0, index)]" @dragstart="drag" />
    </div>
    <div class="fixed left-2 top-[120px] flex  h-28 w-1/4 rotate-180 items-center justify-center">
      ...
      <Card v-for="(card, index) in gameState.players[1].cards" :key="card.img" :card="card" class="absolute !h-[60px] !w-[40px] origin-bottom" :class="calculateRotationClass(1, index)" @dragstart="drag" />
    </div>
    <div class="fixed right-2 top-[120px] flex h-28 w-1/4 rotate-180 items-center justify-center">
      ...
      <Card v-for="(card, index) in gameState.players[2].cards" :key="card.img" :card="card " class="absolute !h-[60px] !w-[40px] origin-bottom" :class="calculateRotationClass(1, index)" @dragstart="drag" />
    </div>
    <div class="fixed  left-2 top-[320px] flex h-28 w-1/4 rotate-180 items-center justify-center">
      ...
      <Card v-for="(card, index) in gameState.players[3].cards" :key="card.img" :card="card" class="absolute !h-[60px] !w-[40px] origin-bottom" :class="calculateRotationClass(1, index)" @dragstart="drag" />
    </div>
    <div class="fixed right-2 top-[320px] flex h-28 w-1/4 rotate-180 items-center justify-center">
      ...
      <Card v-for="(card, index) in gameState.players[4].cards" :key="card.img" :card="card" class="absolute !h-[60px] !w-[40px] origin-bottom" :class="calculateRotationClass(1, index)" @dragstart="drag" />
    </div>
