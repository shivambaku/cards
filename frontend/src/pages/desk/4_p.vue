...
const { gameState, currentRound, dealCards, finishRound, totalRounds, roundsPlayed } = useJudgementGame(4);
// Change player count
...
<template>
  <div class="flex h-screen w-screen items-end overflow-hidden">
    ...
    <div class="fixed right-0 top-[37%] m-1 h-[80px] w-[40px] flex-row items-center justify-center p-1">
